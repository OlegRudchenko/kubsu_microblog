...
describe "User pages" do
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user" do
        ...
        describe "toggling the button" do
          before { click_button "Подписаться" }
      ...
      describe "unfollowing a user" do
        ...
        it "should decrement the followed user count" do
          expect do
            click_button "Отменить подписку"
          end.to change(user.followed_users, :count).by(-1)
        end
        ...
        describe "toggling the button" do
          before { click_button "Отменить подписку" }
  ...
  describe "edit" do
    ...
    describe "page" do
      it { should have_content("Обновить информацию") }
      it { should have_title("Обновить") }
    ...
    describe "with valid information" do
      ...
      before do
        ...
        fill_in "Повторите пароль", with: user.password
  ...
  describe "following/followers" do
    ...
    describe "followed users" do
      ...
      it { should have_title(full_title('Подписки')) }
      it { should have_selector('h3', text: 'Подписки') }
    ...
    describe "followers" do
      ...
      it { should have_title(full_title('Подписчики')) }
      it { should have_selector('h3', text: 'Подписчики') }
